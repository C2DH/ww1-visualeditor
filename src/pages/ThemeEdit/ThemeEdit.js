      ...
      <Col md="3">
        <SideEditToolbar>
          ...
          <ButtonGroup className="margin-bottom-15">
             <Button className="ThemeEdit__action_Colorbutton-taupe-gray" />
             <Button className="ThemeEdit__action_Colorbutton-seven-gray" />
             <Button className="ThemeEdit__action_Colorbutton-dark-gray" />
             <Button className="ThemeEdit__action_Colorbutton-nine-gray" />
             <Button className="ThemeEdit__action_Colorbutton-montana" />
             <Button className="ThemeEdit__action_Colorbutton-gainsboro" />
          </ButtonGroup>
          <FormGroup row>
